str1 = open('o1.txt', 'r').read()
str2 = open('o2.txt', 'r').read()
...
# Durma listesinde tanımlı olan kelimler ve noktalama işaretlerini str1, str2 'den çıkarıyoruz.
for i in durma:
    str1 = str1.replace(i, "")
    str2 = str2.replace(i, "")
...
# set veri türünü kullanarak her iki metni küme haline getiriyorsunuz.
s1 = set(l1)
print(s1)
print(len(s1))
...
# Ardından, her iki kümenin birleşimini alıyorsunuz.
st = set.union(s1, s2)
print(st)
print(len(st))
